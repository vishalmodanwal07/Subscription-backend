...
import { createSubscription, getUserSubscriptions } from "../controllers/subcription.controller.js";
...
subscriptionRouter.get('/user/:id' ,  authories , getUserSubscriptions);
